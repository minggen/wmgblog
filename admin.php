	...
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-header header">
			<div class="layui-main mag0">
				<a href="http://php.wmgblog.pw" class="logo">Myblog</a>
				<!-- 显示/隐藏菜单 -->
				...
				<ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" id="userInfo"><a href="javascript:;"><img
							src="images/face.jpg" class="layui-nav-img userAvatar" width="35"
							height="35"><cite class="adminName">admin</cite></a>
						<dl class="layui-nav-child">
							...
							<dd>
								<a href="javascript:;" data-url="page/user/userInfo.html"
									class=""><i class="layui-icon">&#xe645;</i><cite>系统公告</cite><span
							...
							<dd>
								<a href="javascript:void(0)" class="signOut" onclick="exitlogin()"><i
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a class="img" title="头像"><img src="images/face.jpg"
					class="userAvatar"></a>
				<p>
					你好！<span class="userName"><?php $_SESSION['user']?></span>, 欢迎登录
				</p>
			</div>
			<!-- 搜索 -->
		...
		<div class="layui-footer footer">
			<p>
				<span>copyright @2018 admin</span>
			</p>
		</div>
