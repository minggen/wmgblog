...
class Calendar {
    static function generate() {
        ...
        $url  = '' . ($n_year - 1) . $n_month;//上一年份
        $url2 = '' . ($n_year + 1) . $n_month;//下一年份
        $url3 = '' . $year_down . $m;//上一月份
        $url4 = '' . $year_up . $mj;//下一月份
        
        $calendar ="<table class=\"calendartop\" cellspacing=\"0\"><tr>
        <td>
<a href=\"javascript:void(0);\" onclick=\"sendinfo('$url','Calendar');\"> &laquo; </a>
$n_year2
<a href=\"javascript:void(0);\" onclick=\"sendinfo('$url2','Calendar');\"> &raquo; </a>
</td>
        <td><a href=\"javascript:void(0);\" onclick=\"sendinfo('$url3','Calendar');\"> &laquo; </a>$n_month
    <a href=\"javascript:void(0);\" onclick=\"sendinfo('$url4','Calendar');\"> &raquo; </a></td>
        </tr></table>
